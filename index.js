...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Olá @${num.split('@')[0]}\nBem vindo fdp ao grupo *${mdata.subject}*\n\n𝙿𝚁𝙾𝙸𝙱𝙸𝙳𝙾:\nᴄᴘ\nɢᴀʏ\nᴘᴇᴅɪʀ ᴀᴅᴍ\nɢᴏʀᴇ\nʟᴇᴠᴀʀ ᴏ ɢʀᴜᴘᴏ ᴀ sᴇ́ʀɪᴏ\nɴᴏʀᴍɪᴇ\nɢʜᴏsᴛ\nᴅɪᴠᴜʟɢᴀᴄ̧ᴀ̃ᴏ\nɴᴀ̃ᴏ ғɪϙᴜᴇ sᴏ́ ᴀᴛʀᴀ́s ᴅᴇ ᴄᴏᴍᴀɴᴅᴏs\nᴍᴇɴᴏs ᴅᴇ 200 ᴍᴇɴsᴀɢᴇɴs ᴇᴍ 3 ᴅɪᴀs\n\nᴘᴏʀɴᴏ ᴇ ʜᴇɴᴛᴀɪ ᴀ ɢᴇɴᴛᴇ ᴀᴄᴇɪᴛᴀ ᴍᴀs ᴀᴠɪsᴀ ᴀɴᴛᴇs ᴅᴇ ᴍᴀɴᴅᴀʀ\n\nEspero que goste do grupo ❤️`
				...
				teks = `Tchau @${num.split('@')[0]} Ja foi tarde fdp 😂👋`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '𝗣𝗼𝗿 𝗳𝗮𝘃𝗼𝗿, 𝗮𝗴𝘂𝗮𝗿𝗱𝗲 𝘂𝗺 𝗽𝗼𝘂𝗰𝗼.',
				success: '𝗦𝘂𝗰𝗲𝘀𝘀𝗼 ✔️',
				error: {
					stick: '𝗙𝗮𝗹𝗵𝗮, 𝗼𝗰𝗼𝗿𝗿𝗲𝘂 𝘂𝗺 𝗲𝗿𝗿𝗼 𝗮𝗼 𝗰𝗼𝗻𝘃𝗲𝗿𝘁𝗲𝗿 𝗮 𝗶𝗺𝗮𝗴𝗲𝗺 𝗲𝗺 𝘂𝗺 𝗮𝗱𝗲𝘀𝗶𝘃𝗼 📌',
					Iv: '𝗟𝗶𝗻𝗸 𝗶𝗻𝘃𝗮́𝗹𝗶𝗱𝗼'
				},
				only: {
					group: '𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝘀𝗼́ 𝗽𝗼𝗱𝗲 𝘀𝗲𝗿 𝘂𝘀𝗮𝗱𝗼 𝗲𝗺 𝗴𝗿𝘂𝗽𝗼𝘀!! ❌',
					ownerG: '𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝘀𝗼́ 𝗽𝗼𝗱𝗲 𝘀𝗲𝗿 𝘂𝘀𝗮𝗱𝗼 𝗽𝗲𝗹𝗼 𝗽𝗿𝗼𝗽𝗿𝗶𝗲𝘁𝗮́𝗿𝗶𝗼! ❌',
					ownerB: '❌ 𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝘀𝗼́ 𝗽𝗼𝗱𝗲 𝘀𝗲𝗿 𝘂𝘀𝗮𝗱𝗼 𝗽𝗲𝗹𝗼 𝗯𝗼𝘁 𝗽𝗿𝗼𝗽𝗿𝗶𝗲𝘁𝗮́𝗿𝗶𝗼!t! ❌',
					admin: '❌ 𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝘀𝗼́ 𝗽𝗼𝗱𝗲 𝘀𝗲𝗿 𝘂𝘀𝗮𝗱𝗼 𝗽𝗼𝗿 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿𝗲𝘀 𝗱𝗲 𝗴𝗿𝘂𝗽𝗼 ❌',
					Badmin: '❌ 𝗘𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼 𝘀𝗼́ 𝗽𝗼𝗱𝗲 𝘀𝗲𝗿 𝘂𝘀𝗮𝗱𝗼 𝗾𝘂𝗮𝗻𝗱𝗼 𝗼 𝗯𝗼𝘁 𝘀𝗲 𝘁𝗼𝗿𝗻𝗮 𝗮𝗱𝗺𝗶𝗻𝗶𝘀𝘁𝗿𝗮𝗱𝗼𝗿 ❌'
				}
			}

			const botNumber = client.user.jid
			const ownerNumber = ["5566992007465@s.whatsapp.net"] // replace this with your number
			...
			switch(command) {
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://imgur.com/a/fI2h1mo`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* MATEUS𝐾⃖ ☔\n*YOUTUBE:* https://youtube.com/channel/UCraQ1mqTithGl6h51P6hfmw\n*WPP:* wa.me/+5566992007465\n*INSTAhttps://www.instagram.com/p/CAJXnBGBHs8/?igshid=vd2j0ay3hkt6n\n\nEspero que tenham gostado do bot ❤️'})
					break
				case 'setprefix':
